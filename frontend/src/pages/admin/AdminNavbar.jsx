...
export default function AdminNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between px-10 py-5 border-b border-border-subtle bg-canvas/80 backdrop-blur-md admin-shell">
      <Link
        to="/admin"
      ...
      >
        Smart Campus Resource Portal — Admin
      </Link>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="relative" ref={menuRef}>
          ...
          >
            ...
            <span className="text-xs font-medium normal-case tracking-normal">{user?.name || 'Admin'}</span>
